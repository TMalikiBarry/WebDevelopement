...
export class DescriptionProjetComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.descriptionForm.controls.employesPermanents.setValue(this.demande.projets[0]?.nombreEmploisPermanentMe);
    this.descriptionForm.controls.nombreEmploiAdditionnelsPermanent.setValue(this.demande.projets[0]?.nombreEmploisAdditionnelPermanent);
    ...
    this.descriptionForm.controls.employesNonPermanents.setValue(this.demande.projets[0]?.nombreEmploisNonPermanentMe);
    ...
    this.descriptionForm.controls.NombreFemmesPrevusNonPermanent.setValue(this.demande.projets[0]?.nombreFemmePrevueNonPermanent);
    this.descriptionForm.controls.PourentageFemmessNonPermanent.setValue(this.demande.projets[0]?.pourcentageFemmeNonPermanent+"%");
    this.descriptionForm.controls.NombreJeunessNonPermanent.setValue(this.demande.projets[0]?.nombreJeuneNonPermanent);
    this.descriptionForm.controls.PourcentageJeunessNonPermanent.setValue(this.demande.projets[0]?.pourcentageJeuneNonPermanent+"%");
  ...
  ngOnDestroy(): void {
    ...
    this.data.changeMessageFormMeString(this.descriptionForm.valid+'');
  }
