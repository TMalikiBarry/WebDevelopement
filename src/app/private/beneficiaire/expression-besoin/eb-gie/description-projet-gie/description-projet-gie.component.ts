...
export class DescriptionProjetGieComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.descriptionForm.controls.nombreEmploiAdditionnel.setValue(this.demande.projets[0]?.nombreEmploisAdditionnelPermanent);
    this.descriptionForm.controls.nombreFemmesPrevu.setValue(this.demande.projets[0]?.nombreFemmePrevuePermanent);
    this.descriptionForm.controls.pourcentageFemme.setValue(this.demande.projets[0]?.pourcentageFemmePermanent+"%");
    this.descriptionForm.controls.nombreJeunes.setValue(this.demande.projets[0]?.nombreJeunePermanent);
    this.descriptionForm.controls.pourcentageJeunes.setValue(this.demande.projets[0]?.pourcentageJeunePermanent+"%");
    ...
    this.descriptionForm.controls.NombreEmploisAdditionnelsNonPermanents.setValue(this.demande.projets[0]?.nombreEmploisAdditionnelNonPermanent);
    this.descriptionForm.controls.NombreFemmesPrevuNonPermanents.setValue(this.demande.projets[0]?.nombreFemmePrevueNonPermanent);
    this.descriptionForm.controls.PourentageFemmesNonPermanents.setValue(this.demande.projets[0]?.pourcentageFemmeNonPermanent+"%");
    this.descriptionForm.controls.NombreJeunesNonPermanents.setValue(this.demande.projets[0]?.nombreJeuneNonPermanent);
    this.descriptionForm.controls.PourcentageJeunesNonPermanents.setValue(this.demande.projets[0]?.pourcentageJeuneNonPermanent+"%");
...
// @ts-ignore
  ...
  checkLimitInputsPermanent() {
    ...
    this.descriptionForm.controls.nombreJeunes.addValidators([Validators.required,])
