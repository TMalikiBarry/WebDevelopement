...
if(!this.modalRefFaq) {
    ...
    this.modalRefFaq = this.modalService.info({
      ...
      nzContent: '<div xmlns="http://www.w3.org/1999/html" xmlns="http://www.w3.org/1999/html" xmlns="http://www.w3.org/1999/html" xmlns="http://www.w3.org/1999/html" xmlns="http://www.w3.org/1999/html" xmlns="http://www.w3.org/1999/html" xmlns="http://www.w3.org/1999/html" xmlns="http://www.w3.org/1999/html" xmlns="http://www.w3.org/1999/html" xmlns="http://www.w3.org/1999/html" xmlns="http://www.w3.org/1999/html" xmlns="http://www.w3.org/1999/html" xmlns="http://www.w3.org/1999/html" xmlns="http://www.w3.org/1999/html" xmlns="http://www.w3.org/1999/html" xmlns="http://www.w3.org/1999/html" xmlns="http://www.w3.org/1999/html" xmlns="http://www.w3.org/1999/html">' +
        ...
        '<p>Un service client ouvert 7j/7 de 09 :00 à 18 :00 est également à votre service pour répondre à vos questions concernant Suqali et les offres de nos partenaires financiers au numéro suivant par  <strong>téléphone ou WhatsApp +221 76 624 04 60  </strong></p>' +
        ...
        ' <span class="premierdecalage">   • Pour les micro-entrepreneurs individuels, les montants octroyés par les partenaires de Suqali peuvent aller de 50 mille FCFA à 5 millions FCFA par demande.<strong> Toutefois chaque partenaire de Suqali définit et valide les montants à octroyer à chaque demandeur dans ces fourchettes.</strong></span> </br>' +
        '  <span class="premierdecalage">  • Pour les GIE et entreprises, les montants octroyés par les partenaires de Suqali peuvent aller de 500 mille FCFA à 50 millions FCFA par demande. <strong>Toutefois chaque partenaire de Suqali définit et valide les montants à octroyer à chaque demandeur dans ces fourchettes.</strong></span> </br>' +
        'Les taux d’intérêt annuel dans le cadre de Suqali peuvent variés en fonction des produits financiers et des partenaires mais<strong> tous plafonnés à 5% hors taxe. Chaque partenaire de Suqali définit et valide le taux d’intérêt en fonction de la nature de la demande reçue.</strong> </br>' +
        '</p>' +

        '<h4>Sur quelle durée (maximale) pourrais-je bénéficier du prêt?</h4>' +
        'Ceci dépendra de vos besoins exprimés. Les prêts peuvent aller de 3 mois à 24 mois selon le produit financier. La décision finale sur la durée du prêt sera prise par le partenaire financier de Suqali avec qui vous serez mis en relation.  </br></br>' +
        '<h4>Y’aura-t-il un délai minimal de grâce entre la réception des fonds et le démarrage des remboursements?</h4>' +

        'Ceci dépendra de vos besoins exprimés, des types de financement et de votre situation financière. Les périodes de grâce, partielle ou totale, peuvent aller de 0 à 03 mois. La décision finale sur la durée de la période de grâce sera prise par le partenaire financier de Suqali avec qui vous serez mis en relation. </br> </br>' +
        '<h4>Comment se font les décaissements et les remboursements si jamais ma demande de financement est acceptée?</h4>' +
        'Le décaissement sera effectué directement vers vous par le partenaire financier de Suqali qui aura accepté votre demande.</br>' +
        ...
        ' La liste des partenaires de Suqali qui seront en charge de dispenser les programmes de renforcement de capacités sera publiée sur la plateforme <a routerLink="https://suqali.com">https://suqali.com</a> à une date ultérieure. En vous inscrivant sur la plateforme, vous pourrez recevoir une alerte. </br> </br>' +
        ...
        'Ce projet s’inscrit dans l’initiative d’appuyer les entrepreneurs et entreprises sénégalais touchés par la crise de la COVID19 mais aussi dans le but de favoriser l’inclusion financière à travers les partenaires de Suqali que vous retrouverez sur la plateforme <a routerLink="https://suqali.com">https://suqali.com</a>.</br></br></br>' +
        '<p>' +
